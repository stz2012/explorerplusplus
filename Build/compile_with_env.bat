...
IF EXIST "..\Explorer++\Explorer++\Release\Explorer++.exe" (
    copy /Y "..\Explorer++\Explorer++\Release\Explorer++.exe" .
)
devenv /useenv /build release ..\Translations\Explorer++JA\Explorer++JA.sln
IF EXIST "..\Translations\Explorer++JA\Release\Explorer++JA.dll" (
    copy /Y "..\Translations\Explorer++JA\Release\Explorer++JA.dll" .
)
pause
